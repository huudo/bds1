...
$config = array(
	...
	*/
	...
	'fixed_path_from_filemanager'             => array( '../../sizes/', '../../sizes/',), //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => array( '', ''), //name to prepend on filename
	'fixed_image_creation_to_append'          => array( '_small', '_medium' ), //name to appendon filename
	'fixed_image_creation_width'              => array( 400, 600 ), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array( 275, ''), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	'relative_path_from_current_pos'          => array( '../../sizes/', '../../sizes/' ), //relative path of the image folder from the current position on upload folder
	'relative_image_creation_name_to_prepend' => array( '', 'test_' ), //name to prepend on filename
	'relative_image_creation_name_to_append'  => array( '_small', '_medium' ), //name to append on filename
	'relative_image_creation_width'           => array( 400, 400 ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( 275, '' ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	 */
	'relative_image_creation_option'          => array( 'crop', 'landscape' ), //set the type of the crop

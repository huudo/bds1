...
<div class="edit">
    {!! show_errors($errors) !!}
    {!! Form::model($item, ['method' => 'put', 'route'=>['admin.banner.update', $item->id], 'class'=>'form-horizontal']) !!}
    <div class="row">
        <div class="col-sm-8">
        ...
        <div class="col-sm-4">
            <div class="form-group ">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><label><input type="checkbox" name="groups[]" value="{{$banner->id}}" <?php checkecho($banner->id, $currgroups) ?> > {{$banner->dfname}}</label></li>
                    @endforeach
                    @endif
                </ul>
            </div>

        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="tab-content">
                    <?php
                    $i = 0;
                    foreach ($items->lang as $code=>$value) {
                    $i++;
                    ?>
                    <div class="tab-pane fade in <?php if ($i == 1) echo 'active' ?>" id="lang-{{$code}}">
                        {!! fForm::groupText('Tên danh mục', $code.'[name]', $value->name) !!}
                        {!! fForm::groupText('Đường dẫn tĩnh', $code.'[slug]', $value->slug) !!}
                        {!! fForm::groupTextArea('Mô tả', $code.'[excerpt]', $value->excerpt, ['rows'=>3], 3, 9) !!}
                    </div>
                    <?php
                    }
                    ?>
            ...
            <div class="col-sm-3">
                ...
                <div class="toolbox">
                    ...
                    <div class="collapse in" id="imagebox">
                        {!! fForm::groupUpload($items->image, 12, 12) !!}
                    </div>
                </div>
                {!! fForm::groupSelect('Danh mục cha', 'parent_id', ['0' => 'Chọn danh mục'] + $cats, $items->parent_id, [], 12, 12) !!}
                <div class="row">

...
<div class="addnew">
    <div class="row">
        <div class="col-sm-9">
            {!! lang_tabs() !!}
            {!! Form::model($item, ['method' => 'put', 'route'=>['admin.post.update', $item->id], 'class'=>'form-horizontal']) !!}
            <br />
        ...
        <div class="col-sm-3">
            ...
            <div class="toolbox">
                ...
                {!! fForm::groupSelect('Thẻ đã có', 'availtags[]', $availtags, $currtags, ['class' => 'availtags', 'multiple'], 12, 12) !!}
                <script>
                    (function ($) {
                        $('.newtags').select2({
                            tags: true

...
<div class="addnew">
    <div class="row">
        {!! Form::model($item, ['method' => 'put', 'route'=>['admin.room.update', $item->id], 'class'=>'form-horizontal']) !!}
        <div class="col-sm-9">
            {!! lang_tabs() !!}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-2"><label>Mức 1</label>{!! Form::text('point_1', date('d/m/Y', $item->point_1), ['class' => 'form-control datepicker']) !!}</div>
                <div class="col-sm-2"><label>Giá 2</label>{!! Form::text('price_2', null, ['class' => 'form-control']) !!}</div>
                <div class="col-sm-2"><label>Mức 2</label>{!! Form::text('point_2', date('d/m/Y', $item->point_2), ['class' => 'form-control datepicker']) !!}</div>
                <div class="col-sm-2"><label>Giá 3</label>{!! Form::text('price_3', null, ['class' => 'form-control']) !!}</div>
            </div>
            {!! fForm::groupText('Giá', 'price', null, [], 3, 9) !!}
            {!! fForm::groupText('Phong cảnh nhìn ra', 'room_view', null, [], 3, 9) !!}
            {!! fForm::groupText('Diện tích', 'square', null, [], 3, 9) !!}
            {!! fForm::groupText('Số khách tiêu chuẩn', 'num_adult', null, [], 3, 9) !!}
            {!! fForm::groupText('Giường thêm tối đa', 'add_bed', null, [], 3, 9) !!}

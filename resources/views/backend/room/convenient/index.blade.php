...
<div class="manage_cat">
    ...
    {!! search_title() !!}
    @include('backend.includes.table_bar', ['route' => 'admin.roomconv.index'])
    @if(count($items)>0)
    <div class="table-responsive">
        {!! Form::open(['method' => 'post', 'route' => 'admin.roomconv.massdel', 'class'=>'form-data']) !!}
        <table class="table table-hover table-striped" style="width: 100%;">
            <thead>
                <tr>
                    <th><input type="checkbox" name="massdel"  class="checkall"/></th>
                    <th>{!! link_order('ID', 'admin.roomconv.index', 'id') !!}</th>
                    <th>Image/Icon</th>
                    <th>Tên</th>
                    <th>Trạng thái</th>
                    <th>{!! link_order('Thời gian', 'admin.roomconv.index', 'created_at') !!}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('admin.roomconv.edit', $item->id)}}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Sửa"><i class="fa fa-pencil"></i> Sửa</a>
                        <a href="{{route('admin.roomconv.delete', $item->id)}}" class="btn btn-danger btn-sm item-delete" data-toggle="tooltip" data-placement="top" title="Xóa"><i class="fa fa-close"></i> Xóa</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div class="addnew">
        ...
        <div class="collapse" id="newModal">
            ...
            {!! lang_tabs() !!}
            {!! Form::open(['method' => 'post', 'route'=>'admin.roomconv.store', 'class'=>'form-horizontal']) !!}
            <br />

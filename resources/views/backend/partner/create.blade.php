...
<div class="addnew">
    <div class="row">
        <div class="col-sm-6">
            {!! Form::open(['method' => 'post', 'route'=>'admin.partner.store', 'class'=>'form-horizontal']) !!}
            <br />
            {!! fForm::groupText('Tên đối tác', 'name', null) !!}
            {!! fForm::groupText('Link', 'link', null) !!}
            <div class="toolbox">
                {!! fForm::groupSelect('Trạng thái', 'status', [1=>'Đã đăng', 0=>'Bản nháp'], null, [], 12, 12) !!}
